...
namespace MoyoData
{
    public partial class AgregarSalidaProducto : Form
    {
        ...
        public AgregarSalidaProducto()
        {
            ...
            DtpFechaSalidaProducto.MinDate = DateTime.Now;
            DtpFechaSalidaProducto.MaxDate = DateTime.Now;
        }
        ...
        private void SeleccionarProductos()
        {
            ...
            while (mySqlDataReader.Read())
            {
                ...
                DgvProductos.Rows.Add(false, Convert.ToInt32(mySqlDataReader["idProducto"]), producto.producto, producto.cantidadProducto.ToString(), producto.limteProducto.ToString(), tipoProducto.Item1, tipoProducto.Item2);
            }
